...
export default function FAQPage() {
  ...
  return <ResearchPage label="REFERENCE / FAQ · FACT CHECKED AUGUST 2026" title="Clear answers before the next click" intro="Use these answers to separate spreadsheet discovery from product verification, warehouse inspection and international delivery.">
    ...
    <section className="source-panel"><h2>Official references</h2><ul><li><a href="https://www.superbuy.com/en/page/guide/shoppingagent/">Shopping Agent Guide</a></li><li><a href="https://www.superbuy.com/en/page/guide/feecomposition/">Fees and international shipping composition</a></li><li><a href="https://www.superbuy.com/en/page/guide/transportagent/">Parcel and storage guidance</a></li></ul></section><div className="article-end"><strong>Move from questions to a real record.</strong><p>Search the live index and verify the exact option before placing an order.</p><a href="https://kakobuysn.com/AllProducts/">Browse product records ↗</a></div>
  </ResearchPage>;
}
