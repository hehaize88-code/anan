export function SiteFooter({ research = false }: { research?: boolean }) {
  return <footer>
    <div className="footer-brand"><a className="brand-wordmark footer-wordmark" href="/" aria-label="Sheets Superbuy home"><span>Sheets</span><strong>Superbuy</strong></a><p>{research ? "Independent product research for deliberate buyers." : "Independent research for deliberate buyers."}</p></div>
